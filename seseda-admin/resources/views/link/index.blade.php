...
@section('content')
    ...
    <script>
        document.getElementsByClassName('daohang')[5].classList.add('layui-this');
        ...
        layui.use(['form', 'table', 'laydate', 'jquery'], function () {
            ...
            table.render({
                ...
                cols: [[
                    ...
                    {field: 'url', title: '链接', event: 'setUrl'},
            ...
            table.on('tool(currentTableFilter)', function (obj) {
                ...
                switch (obj.event) {
                    case 'setName':
                        ...
                        break;
                    case 'setUrl':
                        siteUpdate('链接', data.url, data.id, 2, obj);
                        break;
                    case 'category':
                        alert(345);
                        break;
                    ...
                    case 'delete':
                        let index1 = layer.confirm('是否确认删除?', function () {
                            ...
                            $.get("{{route('link_del')}}", {'id': obj.data['id']}, function (data) {
                                layer.closeAll();
                                if (data.code === 0) {
