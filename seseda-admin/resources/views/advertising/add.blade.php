...
<div style="margin-right: 6%">
    <form class="layui-form" action="" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
            @foreach($sites as $item)
                <input type="checkbox" name="site_id[]" value="{{$item->id}}" title="{{$item->name}}">
            @endforeach
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="checkbox" name="is_show" value="1" lay-skin="switch" lay-text="是|否">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="image" autocomplete="off" placeholder="请输入图片链接,或者下面上传图片" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="address" autocomplete="off" placeholder="请输入链接" class="layui-input">
            </div>
        </div>
...
<script>
    layui.use(['form', 'layedit', 'laydate', 'jquery', 'upload'], function () {
        ...
        form.on('submit(demo1)', function (data) {
            ...
            $.post("{{route('advertising_add')}}", data.field, function (data) {
                if (data.code === 0) {
