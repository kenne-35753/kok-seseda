    ...
    jQuery(document).ready(function () {
        jQuery('.kklike-box').live('click', function () {
            ...
            if (onlyUs == '1' && idUser == '0') {
                obj.after(jQuery('<div />').css({
                    'clear': 'none'
                }).addClass('kklike-msg').text('Only registered users can vote.'));
                setTimeout(function () {
            ...
            jQuery.post(kkajax.ajaxurl, wiadomosc, function (dane) {
                ...
                if (dane.msg != '') {
                    obj.after(jQuery('<div />').css({
                        'clear': 'none'
                    }).addClass('kklike-msg').text(dane.msg));
                    setTimeout(function () {
                        jQuery('.kklike-msg').fadeOut('normal');
                    }, 3000);
                }
...
function get_filter_results(start, $form) {
    ...
    jQuery.post(sf_ajax_root, data, function (response) {
...
jQuery(document).ready(function () {
    ...
    jQuery(document).on('click', '.sf-nav-click', function (event) {
        ...
        jQuery('html, body').animate({
            scrollTop: (jQuery('.sf-wrapper').offset().top - 25)
        }, 'slow');
    });
...
! function (a) {
    ...
    return a.effects.effect.size = function (b, c) {
        var d, e, f, g = a(this),
 ...
 */
! function (a) {
    "function" == typeof define && define.amd ? define(["jquery", "./effect", "./effect-size"], a) : a(jQuery)
}(function (a) {
    return a.effects.effect.scale = function (b, c) {
        var d = a(this),
            e = a.extend(!0, {}, b),
...
function set_thisorthat_links() {
    jQuery(".this-or-that-btn").click(function (e) {
        ...
        jQuery(this).parents("#this-or-that").css({
            "min-height": h
        });
        jQuery(this).parents(".this-or-that_item").addClass('selected').animate({}, 400, function () {
            jQuery("#this-or-that").animate({
                opacity: 0
            }, 200);
...
function flickerplate(t) {
    var e = function (t) {
            var e = {
                    body: t.getElementsByTagName("body")[0],
                    html: t.getElementsByTagName("html")[0]
                },
                o = {
                    test: !1
                },
                i = function (t, e) {
                    var o = t.className;
                    null === o.match(new RegExp("\\b" + e + "\\b", "g")) && (t.className = "" === o ? e : o + " " + e)
                },
                n = function (t) {
                    t.removeAttribute("class")
                },
                a = function (t, e) {
                    t.className.indexOf(e) > -1 && (t.className = t.className.split(" ").filter(function (t) {
                        return t != e
                    }).toString().replace(/,/g, " "), "" === t.className && n(t))
                },
                s = function (t) {
                    return null === t || void 0 === typeof t ? !1 : !0
                },
                l = function (t) {
                ...
                p = function (e) {
                    if ("#" === e.charAt(0)) {
                        var o = t.getElementById(e.substring(1));
                        null !== o && o.parentNode.removeChild(o)
                    } else if ("." === e.charAt(0))
                        for (var i = t.querySelectorAll(e), n = i.length - 1; n >= 0; n--) null !== i[n] && i[n].parentNode.removeChild(o)
                },
                f = function (e, o, i) {
                    if ("string" == typeof o && (o = t.createElement(o)), void 0 !== i) {
                        e.appendChild(o).setAttribute("class", i)
                    } else {
                        e.appendChild(o)
                    }
                    for (; e.firstChild !== o;) o.appendChild(e.firstChild)
                };
            return {
                classAdd: i,
                classClear: n,
        ...
        o = t && t.selector ? t.selector : $flickerplateDefault.selector,
        i = o.charAt(0).toString();
    if ("#" === i && o.indexOf(".") < 0) new flickerplateComponent(document.getElementById(o.substring(1)), t, e);
    else
        for (var n = document.querySelectorAll(o), a = 0; a < n.length; a++) new flickerplateComponent(n[a], t, e)
}

function flickerplateComponent(t, e, o) {
    function i() {
        if ("scroller-slide" != k.options.animation && 1 == k.options.arrows) {
            var e = document.createElement("div"),
                o = document.createElement("div");
            e.className = "arrow-navigation left", o.className = "arrow-navigation right", t.insertBefore(e, t.querySelector(".flicks")), t.insertBefore(o, t.querySelector(".flicks"));
            t.querySelectorAll(".arrow-navigation");
            e.onclick = function () {
                --k.options.position < 1 && (k.options.position = k.options.arrowsConstraint ? 1 : v), c(), s()
            }, o.onclick = function () {
                ++k.options.position > v && (k.options.position = k.options.arrowsConstraint ? v : 1), c(), s()
            }
        }
    }

    function n() {
        if ("scroller-slide" !== k.options.animation && k.options.dots === !0) {
            var e = document.createElement("div"),
                i = document.createElement("ul");
            e.className = "dot-navigation " + k.options.dotAlignment;
            for (var n = v - 1; n >= 0; n--) {
                var a = document.createElement("li"),
                    l = document.createElement("div");
                l.className = n === v - 1 ? "dot active" : "dot", a.appendChild(l), i.appendChild(a)
            }
            e.appendChild(i), t.insertBefore(e, t.querySelectorAll(".flicks")[0]);
            for (var r = t.querySelectorAll(".dot-navigation li"), n = r.length - 1; n >= 0; n--) r[n].onclick = function () {
                k.options.position = o.getIndex(this) + 1, o.classRemove(t.querySelector(".dot.active"), "active"), o.classAdd(this.querySelector(".dot"), "active"), c(), s()
            }
        }
    }

    function a() {
        ++k.options.position > v && (k.options.position = 1), c()
    }
    ...
    function l() {
        k.options.autoFlick === !0 && (h = setInterval(a, 1e3 * k.options.autoFlickDelay))
    }

    function r() {
        k.options.autoFlick === !0 && (h = clearInterval(h))
    }

    function c(e) {
        e = e || !1;
        var i = t.querySelector("ul.flicks"),
            n = k.options.position - 1;
        switch (t.setAttribute("data-flickerplate-position", k.options.position), k.options.animation) {
            case "transform-slide":
                var a = "translate3d(-" + n + "%, 0, 0)";
                i.setAttribute("style", "-webkit-transform:" + a + ";-o-transform:" + a + ";-moz-transform:" + a + ";transform:" + a), A = -n;
                break;
            case "transition-fade":
                for (var s = t.querySelectorAll("li"), l = s.length - 1; l >= 0; l--)(function (t) {
                    o.classRemove(s[t], "active")
                })(l);
                o.classAdd(i.querySelector("li:nth-child(" + k.options.position + ")"), "active");
                break;
            case "transition-slide":
                i.style.left = "-" + n + "00%", w = -(n + "00")
        }
        k.options.dots === !0 && e === !1 && (o.classRemove(t.querySelector(".dot.active"), "active"), o.classAdd(t.querySelector(".dot-navigation li:nth-child(" + k.options.position + ") .dot"), "active"))
    }

    function p() {
        if ("function" == typeof Hammer)
            if ("transform-slide" === k.options.animation || "transition-slide" === k.options.animation) {
                var e = new Hammer(t.querySelector("ul.flicks"));
                e.on("panleft panright", function (t) {
                    f(t)
                }), e.on("panend", function (t) {
                    u(t)
                })
            } else if ("transition-fade" === k.options.animation) {
            var e = new Hammer(t.querySelector("ul.flicks"));
            e.on("swipeleft swiperight", function (t) {
                m(t)
            })
        }
    }
    ...
    function f(e) {
        r();
        var i = t.clientWidth,
            n = t.querySelector("ul.flicks");
        switch (o.classRemove(t, "animate-" + k.options.animation), k.options.animation) {
            case "transform-slide":
                o.isTouch() ? $posX = Math.round(e.deltaX / i * 1e3) / 1e3 + A : $posX = Math.round(e.deltaX / i * 10) / 10 + A, 1 == k.options.position && $posX > 0 ? $posX = 0 : k.options.position == v && $posX < -(v - 1) && ($posX = -(v - 1)), C = "translate3d(" + $posX + "%, 0, 0)", n.setAttribute("style", "-webkit-transform:" + C + ";-o-transform:" + C + ";-moz-transform:" + C + ";transform:" + C);
                break;
            case "transition-slide":
                $posX = Math.round(e.deltaX / i * 100) + w, 1 == k.options.position && $posX > 0 ? $posX = 0 : k.options.position == v && $posX < 100 * -(v - 1) && ($posX = -(100 * (v - 1))), n.style.left = $posX + "%"
        }
    }

    function u(e) {
        var i = e.deltaX;
        o.classAdd(t, "animate-" + k.options.animation), -$ > i && k.options.position < v ? k.options.position++ : i > $ && k.options.position > 1 && k.options.position--, setTimeout(function () {
            c()
        }, 10), l()
    }

    function d() {
        o.classAdd(t, "flickerplate theme-" + k.options.theme + " animate-" + k.options.animation), o.classAdd(t.getElementsByTagName("ul")[0], "flicks"), t.setAttribute("data-flickerplate-position", k.options.position), c(!0);
        for (var e = t.querySelectorAll("ul.flicks > li"), i = e.length - 1; i >= 0; i--) {
            v++, o.wrapInner(e[i], "div", "flick-inner"), o.wrapInner(e[i].querySelectorAll(".flick-inner")[0], "div", "flick-content");
            var n = e[i].getAttribute("data-background") || !1;
            n !== !1 && (e[i].style.backgroundImage = "url(" + n + ")")
        }
        "scroller-slide" != k.options.animation && "jquery-slide" != k.options.animation && "jquery-fade" != k.options.animation && t.addEventListener(g, function () {
            y = !1
        })
    }

    function m(t) {
        "swipeleft" == t.type ? ++k.options.position > v && (k.options.position = k.options.arrowsConstraint ? v : 1) : "swiperight" == t.type && --k.options.position < 1 && (k.options.position = k.options.arrowsConstraint ? 1 : v), c(), s()
    }
    o.isTouch() || o.hasClass(o.element.html, "flickerplate-no-touch") || o.classAdd(o.element.html, "flickerplate-no-touch");
    var h, k = this,
        v = 0,
        y = !1,
        g = "transitionend MSTransitionEnd webkitTransitionEnd oTransitionEnd",
        w = 0,
        A = 0,
        C = "translate3d(0, 0, 0)",
        $ = 100;
    e = e || !1, k.options = {
        selector: e.selector || $flickerplateDefault.selector,
        animation: e.animation || $flickerplateDefault.animation,
        arrows: "undefined" != typeof e.arrows ? e.arrows : $flickerplateDefault.arrows,
        arrowsConstraint: "undefined" != typeof e.arrowsConstraint ? e.arrowsConstraint : $flickerplateDefault.arrowsConstraint,
        autoFlick: "undefined" != typeof e.autoFlick ? e.autoFlick : $flickerplateDefault.autoFlick,
        autoFlickDelay: e.autoFlickDelay || $flickerplateDefault.autoFlickDelay,
        dotAlignment: e.dotAlignment || $flickerplateDefault.dotAlignment,
        dots: "undefined" != typeof e.dots ? e.dots : $flickerplateDefault.dots,
        position: e.position || $flickerplateDefault.position,
        theme: e.theme || $flickerplateDefault.theme
    }, d(), i(), n(), l(), o.isTouch() && p()
}
