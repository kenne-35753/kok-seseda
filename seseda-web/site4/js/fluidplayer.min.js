...
var fluidPlayerClass = {
    ...
    notCloned: ["notCloned", "vttParserScript", "instances", "getInstanceById", "requestStylesheet",
        "reqiestScript", "isTouchDevice", "vastOptions", "displayOptions", "getEventOffsetX", "getEventOffsetY",
        "getTranslateX", "toggleElementText", "getMobileOs", "findClosestParent", "activeVideoPlayerId",
        "getInstanceIdByWrapperId", "timer", "timerPool", "adList", "adPool", "isUserActive",
        "isCurrentlyPlayingAd", "initialAnimationSet"],
    version: "2.4.7",
        ...
        for (var i = 0; i < trackingEvents.length; i++) {
            ...
            switch (eventType) {
                ...
                case "progress":
                    ...
                    tmpOptions.tracking[eventType][oneEventOffset].elements.push(trackingEvents[i].childNodes[0]
                        .nodeValue);
                    break;
                default:
                    break
    ...
    registerErrorEvents: function (errorTags, tmpOptions) {
        if (typeof errorTags !== "undefined" && errorTags !== null && errorTags.length === 1 && errorTags[0].childNodes
            .length === 1) {
    ...
    processVastXml: function (xmlResponse, tmpOptions, callBack) {
        ...
        if (typeof creative !== "undefined" && creative.length) {
            ...
            if (typeof arrayCreativeLinears !== "undefined" && arrayCreativeLinears !== null &&
                ...
                if (!player.hasVastAdTagUri(xmlResponse) && player.hasInLine(xmlResponse)) {
                    ...
                    tmpOptions.skipoffset = player.convertTimeStringToSeconds(creativeLinear.getAttribute(
                        "skipoffset"));
            ...
            if (typeof arrayCreativeNonLinears !== "undefined" && arrayCreativeNonLinears !== null &&
            ...
            if (!player.hasVastAdTagUri(xmlResponse) && player.hasInLine(xmlResponse)) {
                if (typeof tmpOptions.mediaFileList !== "undefined" || typeof tmpOptions.staticResource !==
                    "undefined") {
        ...
        var handleVastResult = function (pass, tmpOptions) {
            if (pass) {
                if (tmpOptions.adType === "linear") {
                    if (typeof tmpOptions.iconClick !== "undefined" && tmpOptions.iconClick !== null &&
    ...
    resolveVastTag: function (vastTag, numberOfRedirects, tmpOptions, callBack) {
        ...
        var handleXmlHttpReq = function () {
            ...
            if (numberOfRedirects > player.displayOptions.vastOptions.maxAllowedVastTagRedirects && !player
                .inLineFound) {
                callBack(false);
                return
            }
    ...
    renderVideoAd: function (adListId, backupTheVideoTime) {
        ...
        var playVideoPlayer = function (adListId) {
            player.switchPlayerToVastMode = function () {
                ...
                var addClickthroughLayer = typeof player.adList[adListId].adClickable != "undefined" ?
                    player.adList[adListId].adClickable : player.displayOptions.vastOptions.adClickable;
                ...
                var progressbarContainer = document.getElementById(player.videoPlayerId +
                    "_fluid_controls_progress_container");
                if (progressbarContainer !== null) {
                    document.getElementById(player.videoPlayerId + "_vast_control_currentprogress").style
                        .backgroundColor = player.displayOptions.layoutControls.adProgressColor
                }
                if (player.displayOptions.vastOptions.adText || player.adList[adListId].adText) {
                    var adTextToShow = player.adList[adListId].adText !== null ? player.adList[adListId]
                        .adText : player.displayOptions.vastOptions.adText;
    ...
    scheduleTrackingEvent: function (currentTime, duration) {
        ...
        if (typeof player.vastOptions.tracking["progress"] !== "undefined" && player.vastOptions.tracking[
                "progress"].length && typeof player.vastOptions.tracking["progress"][currentTime] !==
            "undefined") {
    ...
    trackSingleEvent: function (eventType, eventSubType) {
        ...
        switch (eventType) {
            ...
            case "complete":
                ...
                break;
            case "progress":
                player.vastOptions.tracking["progress"][eventSubType].elements.forEach(function (currentValue,
                    index) {
                    if (player.vastOptions.tracking["progress"][eventSubType].stopTracking === false &&
                ...
                break;
            case "impression":
                if (typeof player.vastOptions.impression !== "undefined" && player.vastOptions.impression !==
                    null && typeof player.vastOptions.impression.length !== "unknown") {
    ...
    createNonLinearStatic: function (adListId) {
        ...
        player.adFinished = false;
        player.trackSingleEvent("start");
        var duration = player.adList[adListId].nonLinearDuration ? player.adList[adListId].nonLinearDuration :
    ...
    createBoard: function (adListId) {
        ...
        if (typeof vastSettings.staticResource === "undefined" || player.supportedStaticTypes.indexOf(
                vastSettings.creativeType) === -1) {
            player.adList[adListId].error = true;
    ...
    rollGroupContainsLinear: function (groupedRolls) {
        ...
        for (var i = 0; i < groupedRolls.length; i++) {
            if (player.adList[groupedRolls[i].id].adType && player.adList[groupedRolls[i].id].adType ===
                "linear") {
                found = true;
                break
            }
    ...
    midRoll: function (event) {
        ...
        if (player.displayOptions.vastOptions.showProgressbarMarkers && player.adList[adListId].adType ===
            "nonLinear") {
    ...
    hasValidOnPauseAd: function () {
        ...
        return onPauseAd.length != 0 && player.adList[onPauseAd[0]] && player.adList[onPauseAd[0]].error ===
            false
    },
    ...
    adKeytimePlay: function (keyTime) {
        ...
        if (timerPoolKeytimeCloseStaticAdsLength === 0 && timerPoolKeytimeLinearAdsLength === 0 &&
    ...
    switchToMainVideo: function () {
        ...
        var newCurrentTime = typeof videoPlayerTag.mainVideoCurrentTime !== "undefined" ? videoPlayerTag.mainVideoCurrentTime :
            0;
        ...
        var progressbarContainer = document.getElementById(player.videoPlayerId +
            "_fluid_controls_progress_container");
        if (progressbarContainer !== null) {
            var backgroundColor = player.displayOptions.layoutControls.primaryColor ? player.displayOptions.layoutControls
                .primaryColor : "white";
            document.getElementById(player.videoPlayerId + "_vast_control_currentprogress").style.backgroundColor =
                backgroundColor
        }
    ...
    addSkipButton: function () {
        ...
        divSkipButton.innerHTML = this.displayOptions.vastOptions.skipButtonCaption.replace("[seconds]", this.vastOptions
            .skipoffset);
    ...
    addAdCountdown: function () {
        ...
        var adCountdown = this.pad(parseInt(this.currentVideoDuration / 60)) + ":" + this.pad(parseInt(this.currentVideoDuration %
            60));
    ...
    positionTextElements: function (adListData) {
        ...
        if (ctaButton !== null) {
            ...
            if (isBottom && positionsCTA[1] == "right") {
                ctaButton.style[positionsCTA[0]] = defaultPositions[positionsCTA[0]][positionsCTA[1]].v +
                    skipButtonHeightWithSpacing + "px"
            }
            ctaButtonHeightWithSpacing = ctaButton.offsetHeight + pixelSpacing + "px"
        }
        if (adPlayingDiv !== null) {
            var adPlayingDivPosition = adListData.adTextPosition !== null ? adListData.adTextPosition.toLowerCase() :
        ...
        if (ctaButtonHeightWithSpacing > 0 && adPlayingDivHeightWithSpacing > 0 && CTATextPosition ==
            adPlayingDivPosition) {
            if (isBottom) {
                if (positionsCTA[1] == "right") {
                    adPlayingDiv.style.bottom = defaultPositions[positionsAdText[0]][positionsAdText[1]].v +
                        skipButtonHeightWithSpacing + ctaButtonHeightWithSpacing + "px"
                } else {
                    adPlayingDiv.style.bottom = defaultPositions[positionsAdText[0]][positionsAdText[1]].v +
                        ctaButtonHeightWithSpacing + "px"
                }
            } else {
                ctaButton.style.top = defaultPositions[positionsCTA[0]][positionsCTA[1]].v +
                    adPlayingDivHeightWithSpacing + "px"
            }
        }
    },
    ...
    addCTAButton: function (landingPage) {
        ...
        link.innerHTML = this.displayOptions.vastOptions.adCTAText +
            '<br/><span class="add_icon_clickthrough">' + landingPage + "</span>";
    ...
    decreaseSkipOffset: function decreaseSkipOffset() {
        ...
        if (btn) {
            if (sec >= 1) {
                ...
                btn.innerHTML = '<a href="javascript:;" id="skipHref_' + player.videoPlayerId +
                    '" onclick="fluidPlayerClass.getInstanceById(\'' + player.videoPlayerId +
                    "').pressSkipButton();\">" + player.displayOptions.vastOptions.skipButtonClickCaption +
                    "</a>";
    ...
    addClickthroughLayer: function () {
        ...
        divClickThrough.setAttribute("style", "position: absolute; cursor: pointer; top: 0; left: 0; width: " +
            videoPlayerTag.offsetWidth + "px; height: " + videoPlayerTag.offsetHeight + "px;");
        ...
        var isIos9orLower = player.mobileInfo.device === "iPhone" && player.mobileInfo.userOsMajor !== false &&
    ...
    convertTimeStringToSeconds: function (str) {
        if (str && str.match(/^(\d){2}(:[0-5][0-9]){2}(.(\d){1,3})?$/)) {
            ...
            return parseInt(timeParts[0], 10) * 3600 + parseInt(timeParts[1], 10) * 60 + parseInt(timeParts[2],
                10)
        }
        return false
    },
    ...
    generateCustomControlTags: function () {
        return '<div class="fluid_controls_left">' + '   <div id="' + this.videoPlayerId +
            '_fluid_control_playpause" class="fluid_button fluid_button_play"></div>' + "</div>" + '<div id="' +
            this.videoPlayerId +
            '_fluid_controls_progress_container" class="fluid_controls_progress_container fluid_slider">' +
            '   <div class="fluid_controls_progress">' + '      <div id="' + this.videoPlayerId +
            '_vast_control_currentprogress" class="fluid_controls_currentprogress">' + '          <div id="' +
            this.videoPlayerId + '_vast_control_currentpos" class="fluid_controls_currentpos"></div>' +
            "      </div>" + "   </div>" + '   <div id="' + this.videoPlayerId +
            '_buffered_amount" class="fluid_controls_buffered"></div>' + '   <div id="' + this.videoPlayerId +
            '_ad_markers_holder" class="fluid_controls_ad_markers_holder"></div>' + "</div>" +
            '<div class="fluid_controls_right">' + '   <div id="' + this.videoPlayerId +
            '_fluid_control_fullscreen" class="fluid_button fluid_button_fullscreen"></div>' + '   <div id="' +
            this.videoPlayerId + '_fluid_control_theatre" class="fluid_button fluid_button_theatre"></div>' +
            '   <div id="' + this.videoPlayerId +
            ...
            "           </div>" + "       </div>" + "   </div>" + '   <div id="' + this.videoPlayerId +
            '_fluid_control_mute" class="fluid_button fluid_button_volume"></div>' + '   <div id="' + this.videoPlayerId +
            '_fluid_control_duration" class="fluid_fluid_control_duration">00:00 / 00:00</div>' + "</div>"
    },
    controlPlayPauseToggle: function (videoPlayerId) {
        ...
        if (!videoPlayer.paused) {
            playPauseButton.className = playPauseButton.className.replace(/\bfluid_button_play\b/g,
                "fluid_button_pause");
            ...
            playPauseButton.className = playPauseButton.className.replace(/\bfluid_button_pause\b/g,
                "fluid_button_play");
    ...
    playPauseAnimationToggle: function (play) {
        ...
        if (play) {
            document.getElementById(videoPlayerId + "_fluid_state_button").classList.remove(
                "fluid_initial_pause_button");
            document.getElementById(videoPlayerId + "_fluid_state_button").classList.add(
        ...
        setTimeout(function () {
            document.getElementById(videoPlayerSaveId + "_fluid_initial_play").classList.remove(
                "transform-active")
        }, 800)
    },
    ...
    contolVolumebarUpdate: function (videoPlayerId) {
        ...
        if (videoPlayerTag.volume && !videoPlayerTag.muted) {
            muteButtonTag.className = muteButtonTag.className.replace(/\bfluid_button_mute\b/g,
                "fluid_button_volume");
            if (menuOptionMute !== null) {
                menuOptionMute.innerHTML = this.displayOptions.captions.mute
            }
        } else {
            muteButtonTag.className = muteButtonTag.className.replace(/\bfluid_button_volume\b/g,
                "fluid_button_mute");
            if (menuOptionMute !== null) {
    ...
    fullscreenOff: function (fullscreenButton, menuOptionFullscreen) {
        fullscreenButton.className = fullscreenButton.className.replace(/\bfluid_button_fullscreen_exit\b/g,
    ...
    fullscreenOn: function (fullscreenButton, menuOptionFullscreen) {
        fullscreenButton.className = fullscreenButton.className.replace(/\bfluid_button_fullscreen\b/g,
    ...
    getTranslateX: function (el) {
        ...
        try {
            ...
            if (results && results.length) {
                coordinates = results[0].replace("translate3d(", "").replace(")", "").replace(/\s/g, "").replace(
                    /px/g, "").split(",")
            }
        } catch (e) {
            coordinates = null
    ...
    getEventOffsetY: function (evt, el) {
        ...
        if (videoWrapper) {
            ...
            var requestFullscreenFunctionNames = fluidPlayerClass.checkFullscreenSupport("fluid_video_wrapper_" +
                videoPlayerId);
    ...
    onProgressbarMouseDown: function (videoPlayerId, event) {
        ...
        var initialPosition = fluidPlayerClass.getEventOffsetX(event, document.getElementById(videoPlayerId +
            "_fluid_controls_progress_container"));
        if (player.isCurrentlyPlayingAd) {
            return
        }
        ...
        function onProgressbarMouseMove(event) {
            var currentX = fluidPlayerClass.getEventOffsetX(event, document.getElementById(videoPlayerId +
                "_fluid_controls_progress_container"));
            initialPosition = NaN;
        ...
        function onProgressbarMouseUp(event) {
            ...
            var clickedX = fluidPlayerClass.getEventOffsetX(event, document.getElementById(videoPlayerId +
                "_fluid_controls_progress_container"));
    ...
    onVolumebarMouseDown: function (videoPlayerId) {
        ...
        function onVolumebarMouseMove(event) {
            var currentX = fluidPlayerClass.getEventOffsetX(event, document.getElementById(videoPlayerId +
                "_fluid_control_volume_container"));
    ...
    setVastList: function () {
        ...
        var validateRequiredParams = function (item) {
            ...
            if (player.availableRolls.indexOf(item.roll) === -1) {
                player.announceLocalError(102, "Only " + player.availableRolls.join(",") +
                    " rolls are supported.");
                hasError = true
            }
            if (item.size && player.supportedNonLinearAd.indexOf(item.size) === -1) {
                player.announceLocalError(102, "Only " + player.supportedNonLinearAd.join(",") +
                    " size are supported.");
                hasError = true
            }
            return hasError
    ...
    currentTimeChange: function (videoPlayerId, keyCode) {
        ...
        var videoPlayerTag = document.getElementById(videoPlayerId);
        videoPlayerTag.currentTime = videoInstanceId.getNewCurrentTimeValueByKeyCode(keyCode, videoPlayerTag.currentTime,
    ...
    handleMouseleave: function (event) {
        ...
        var videoPlayerInstance = fluidPlayerClass.getInstanceById(videoInstanceId);
        if (typeof event.clientX !== "undefined" && document.getElementById("fluid_video_wrapper_" +
                videoInstanceId).contains(document.elementFromPoint(event.clientX, event.clientY))) {
            return
        }
    ...
    keyboardControl: function () {
        ...
        window.addEventListener("click", function (e) {
            ...
            if (document.getElementById("fluid_video_wrapper_" + videoInstanceId).contains(e.target) ||
                e.target.id == "skipHref_" + videoInstanceId) {} else {
    ...
    initialPlay: function () {
        ...
        if (!player.displayOptions.layoutControls.playButtonShowing) {
            var initialControlsDisplay = document.getElementById(player.videoPlayerId +
                "_fluid_controls_container");
    ...
    playPauseToggle: function (videoPlayerTag) {
        ...
        if (!isFirstStart || preRolls.length == 0) {
            ...
            player.isCurrentlyPlayingAd = true;
            if (browserVersion.browserName == "Safari" || player.mobileInfo.userOs !== false && player.mobileInfo
                .userOs == "Android" && browserVersion.browserName == "Google Chrome") {
    ...
    setCustomControls: function () {
        var player = this;
        var videoPlayerTag = document.getElementById(this.videoPlayerId);
        document.getElementById(this.videoPlayerId + "_fluid_control_playpause").addEventListener("click",
            function () {
                if (!player.firstPlayLaunched) {
                    videoPlayerTag.removeEventListener("play", player.initialPlay)
                }
        ...
        document.getElementById(player.videoPlayerId + "_fluid_control_mute").addEventListener("click",
            function () {
                player.muteToggle(player.videoPlayerId)
            });
        player.setBuffering();
        document.getElementById(player.videoPlayerId + "_fluid_control_fullscreen").addEventListener("click",
            function () {
                player.fullscreenToggle()
            });
        if (player.displayOptions.layoutControls.allowTheatre && !player.isInIframe) {
            document.getElementById(player.videoPlayerId + "_fluid_control_theatre").addEventListener("click",
                function () {
    ...
    createTimePositionPreview: function () {
        ...
        var progressContainer = document.getElementById(player.videoPlayerId +
            "_fluid_controls_progress_container");
        ...
        document.getElementById(player.videoPlayerId + "_fluid_controls_progress_container").addEventListener(
            ...
            function (event) {
                ...
                var hoverTimeItem = document.getElementById(player.videoPlayerId +
                    "_fluid_timeline_preview");
    ...
    setCustomContextMenu: function () {
        ...
        divContextMenu.innerHTML = "<ul>" + '    <li id="' + player.videoPlayerId + 'context_option_play">' +
            this.displayOptions.captions.play + "</li>" + '    <li id="' + player.videoPlayerId +
            'context_option_mute">' + this.displayOptions.captions.mute + "</li>" + '    <li id="' + player.videoPlayerId +
            'context_option_fullscreen">' + this.displayOptions.captions.fullscreen + "</li>" + '    <li id="' +
            player.videoPlayerId + 'context_option_homepage">Fluid Player ' + player.version + "</li>" +
            "</ul>";
    ...
    setupThumbnailPreviewVtt: function () {
        var player = this;
        player.sendRequest(player.displayOptions.layoutControls.timelinePreview.file, true, player.displayOptions
            .vastOptions.vastTimeout,
            function () {
                var convertVttRawData = function (vttRawData) {
                    ...
                    for (var i = 0; i < vttRawData.cues.length; i++) {
                        ...
                        var xCoords = 0,
                            ...
                            wCoords = 122.5,
                            hCoords = 69;
                        if (tempThumbnailData.length === 2 && tempThumbnailData[1].indexOf("xywh=") ===
                            0) {
                        ...
                        if (player.displayOptions.layoutControls.timelinePreview.spriteRelativePath &&
                            player.displayOptions.layoutControls.timelinePreview.file.indexOf("/") !==
                            -1 && (typeof player.displayOptions.layoutControls.timelinePreview.sprite ===
                                "undefined" || player.displayOptions.layoutControls.timelinePreview.sprite ==
                                "")) {
                            imageUrl = player.displayOptions.layoutControls.timelinePreview.file.substring(
                                0, player.displayOptions.layoutControls.timelinePreview.file.lastIndexOf(
                                    "/"));
    ...
    getThumbnailCoordinates: function (second) {
        ...
        if (player.timelinePreviewData.length) {
            for (var i = 0; i < player.timelinePreviewData.length; i++) {
                if (second >= player.timelinePreviewData[i].startTime && second <= player.timelinePreviewData[i]
                    .endTime) {
    ...
    drawTimelinePreview: function (event) {
        var player = this;
        var timelinePreviewTag = document.getElementById(player.videoPlayerId +
            "_fluid_timeline_preview_container");
        var timelinePreviewShadow = document.getElementById(player.videoPlayerId +
        ...
        if (totalWidth) {
            ...
            if (thumbnailCoordinates !== false) {
                ...
                timelinePreviewTag.style.background = "url(" + thumbnailCoordinates.image +
                    ") no-repeat scroll -" + thumbnailCoordinates.x + "px -" + thumbnailCoordinates.y + "px";
    ...
    setupThumbnailPreview: function () {
        var player = this;
        if (player.displayOptions.layoutControls.timelinePreview && typeof player.displayOptions.layoutControls
            .timelinePreview.file === "string" && typeof player.displayOptions.layoutControls.timelinePreview.type ===
            "string") {
            switch (player.displayOptions.layoutControls.timelinePreview.type) {
                case "VTT":
                    fluidPlayerClass.requestScript(fluidPlayerScriptLocation + fluidPlayerClass.vttParserScript,
                    ...
                    document.getElementById(player.videoPlayerId + "_fluid_controls_progress_container").addEventListener(
                        eventOn, player.drawTimelinePreview.bind(player), false);
                    document.getElementById(player.videoPlayerId + "_fluid_controls_progress_container").addEventListener(
                        eventOff,
                        function (event) {
                            var progress = document.getElementById(player.videoPlayerId +
                                "_fluid_controls_progress_container");
                            if (typeof event.clientX !== "undefined" && progress.contains(document.elementFromPoint(
                                    event.clientX, event.clientY))) {
                                return
                            }
                            document.getElementById(player.videoPlayerId +
                                "_fluid_timeline_preview_container").style.display = "none";
                            document.getElementById(player.videoPlayerId +
                                "_fluid_timeline_preview_container_shadow").style.display = "none"
                        }, false);
    ...
    setupPlayerWrapper: function () {
        ...
        divVideoWrapper.className = fluidPlayerClass.isTouchDevice() ? "fluid_video_wrapper mobile" :
            "fluid_video_wrapper";
    ...
    createSubtitlesSwitch: function () {
        ...
        if (player.displayOptions.layoutControls.subtitlesEnabled) {
            ...
            var subtitlesChangeButton = document.getElementById(player.videoPlayerId +
                "_fluid_control_subtitles");
            ...
            player.subtitlesTracks.forEach(function (subtitle) {
                ...
                subtitlesChangeDiv.innerHTML = '<span class="subtitle_button_icon ' + subtitleSelected +
                    '"></span>' + subtitle.label;
                subtitlesChangeDiv.addEventListener("click", function (event) {
                    ...
                    for (var i = 0; i < subtitleIcons.length; i++) {
                        subtitleIcons[i].className = subtitleIcons[i].className.replace(
                            "subtitle_selected", "")
                    }
            ...
            if (appendSubtitleChange) {
                ...
                document.getElementById(player.videoPlayerId + "_fluid_control_subtitles").style.display =
                    "none"
            }
        } else {
    ...
    createSubtitles: function () {
        ...
        fluidPlayerClass.requestScript(fluidPlayerScriptLocation + fluidPlayerClass.subtitlesParseScript,
    ...
    createVideoSourceSwitch: function () {
        ...
        if (player.videoSources.length > 1) {
            var sourceChangeButton = document.getElementById(player.videoPlayerId +
                "_fluid_control_video_source");
            ...
            player.videoSources.forEach(function (source) {
                ...
                var hdElement = source.isHD ? '<sup style="color:' + player.displayOptions.layoutControls
                    .primaryColor + '" class="fp_hd_source"></sup>' : "";
                firstSource = false;
                ...
                sourceChangeDiv.innerHTML = '<span class="source_button_icon ' + sourceSelected +
                    '"></span>' + source.title + hdElement;
                sourceChangeDiv.addEventListener("click", function (event) {
                    ...
                    for (var i = 0; i < sourceIcons.length; i++) {
                        sourceIcons[i].className = sourceIcons[i].className.replace(
                            "source_selected", "")
                    }
            ...
            if (appendSourceChange) {
                ...
                document.getElementById(player.videoPlayerId + "_fluid_control_video_source").style.display =
                    "none"
            }
        } else {
            document.getElementById(player.videoPlayerId + "_fluid_control_video_source").style.display =
    ...
    openCloseVideoSourceSwitch: function () {
        ...
        var sourceChangeListContainer = document.getElementById(this.videoPlayerId +
            "_fluid_control_video_source");
        if (player.isCurrentlyPlayingAd) {
            sourceChangeList.style.display = "none";
            return
    ...
    setCurrentTimeAndPlay: function (newCurrentTime, shouldPlay) {
        ...
        var loadedMetadata = function () {
            ...
            if (player.mobileInfo.userOs == "iOS" || player.getBrowserVersion().browserName.toLowerCase() ===
                "safari") {
    ...
    initPlayButton: function () {
        ...
        var backgroundColor = player.displayOptions.layoutControls.primaryColor ? player.displayOptions.layoutControls
            .primaryColor : "#333333";
        containerDiv.innerHTML = '<div id="' + player.videoPlayerId +
            '_fluid_initial_play" class="fluid_initial_play" style="background-color:' + backgroundColor +
            '"><div id="' + player.videoPlayerId +
    ...
    mainVideoReady: function () {
        var videoPlayerTag = this;
        var player = fluidPlayerClass.getInstanceById(this.id);
        if (player.mainVideoDuration == 0 && !player.isCurrentlyPlayingAd && player.mainVideoReadyState ===
            false) {
    ...
    userActivityChecker: function () {
        ...
        var listenTo = fluidPlayerClass.isTouchDevice() ? ["touchstart", "touchmove", "touchend"] : [
    ...
    hideControlBar: function () {
        ...
        if (videoPlayerInstance.hasControlBar()) {
            var divVastControls = document.getElementById(videoPlayerInstance.videoPlayerId +
                "_fluid_controls_container");
            ...
            if (duration > 0) {
                for (var i = 0; i < videoPlayer.buffered.length; i++) {
                    if (videoPlayer.buffered.start(videoPlayer.buffered.length - 1 - i) < videoPlayer.currentTime) {
                        bufferBar.style.width = videoPlayer.buffered.end(videoPlayer.buffered.length - 1 -
                            i) / duration * 100 + "%";
    ...
    createPlaybackList: function () {
        ...
        if (player.displayOptions.layoutControls.playbackRateEnabled) {
            ...
            document.getElementById(player.videoPlayerId + "_fluid_control_playback_rate").style.display =
                "none"
        }
    },
    openCloseVideoPlaybackRate: function () {
        var player = this;
        var sourceChangeList = document.getElementById(this.videoPlayerId +
            ...
            switch (this.displayOptions.layoutControls.theatreSettings.horizontalAlign) {
                case "center":
                    if (typeof workingWidth == "string" && workingWidth.substr(workingWidth.length - 1) == "%") {
                        defaultHorizontalMargin = (100 - parseInt(workingWidth.substring(0, workingWidth.length -
                            1))) / 2 + "%"
                    } else if (typeof workingWidth == "string" && workingWidth.substr(workingWidth.length - 2) ==
                        "px") {
                        defaultHorizontalMargin = (screen.width - parseInt(workingWidth.substring(0,
                            workingWidth.length - 2))) / screen.width * 100 / 2 + "%"
                    } else {
    ...
    posterImage: function () {
        if (this.displayOptions.layoutControls.posterImage) {
            ...
            containerDiv.style.background = "url('" + this.displayOptions.layoutControls.posterImage +
                "') center center / " + this.displayOptions.layoutControls.posterImageSize + " no-repeat black";
        ...
        switch (this.displayOptions.layoutControls.mediaType) {
            case "application/dash+xml":
                if (!this.dashScriptLoaded) {
                    ...
                    fluidPlayerClass.requestScript(fluidPlayerScriptLocation + fluidPlayerClass.dashJsScript,
            ...
            case "application/x-mpegURL":
                if (!this.hlsScriptLoaded && !window.Hls) {
                    ...
                    fluidPlayerClass.requestScript(fluidPlayerScriptLocation + fluidPlayerClass.hlsJsScript,
    ...
    setPersistentSettings: function () {
        if (typeof Storage !== "undefined" && typeof localStorage !== "undefined") {
            ...
            if (typeof this.fluidStorage.fluidVolume !== "undefined" && this.displayOptions.layoutControls.persistentSettings
                .volume) {
            ...
            if (typeof this.fluidStorage.fluidQuality !== "undefined" && this.displayOptions.layoutControls.persistentSettings
                .quality) {
                var sourceOption = document.getElementById("source_" + this.videoPlayerId + "_" + this.fluidStorage
                    .fluidQuality);
                var sourceChangeButton = document.getElementById(this.videoPlayerId +
                    "_fluid_control_video_source");
                if (sourceOption) {
                    sourceOption.click();
            ...
            if (typeof this.fluidStorage.fluidSpeed !== "undefined" && this.displayOptions.layoutControls.persistentSettings
                .speed) {
                this.setPlaybackSpeed(this.fluidStorage.fluidSpeed)
            }
            if (typeof this.fluidStorage.fluidTheatre !== "undefined" && this.fluidStorage.fluidTheatre ==
                "true" && this.displayOptions.layoutControls.persistentSettings.theatre) {
                this.theatreToggle()
            }
        }
    },
            ...
            try {
                ...
                if (promise !== undefined && promise !== null) {
                    promise.then(function () {
                        ...
                        var isAbortError = typeof error.name !== "undefined" && error.name ===
                            "AbortError";
    ...
    isCurrentlyPlayingVideo: function (instance) {
        return instance && instance.currentTime > 0 && !instance.paused && !instance.ended && instance.readyState >
            2
    },
    ...
    toggleLogo: function (logo) {
        ...
        this.displayOptions.layoutControls.logo.mouseOverImageUrl = logo.mouseOverImageUrl ? logo.mouseOverImageUrl :
            null;
        this.displayOptions.layoutControls.logo.imageMargin = logo.imageMargin ? logo.imageMargin : "2px";
        this.displayOptions.layoutControls.logo.hideWithControls = logo.hideWithControls ? logo.hideWithControls :
            false;
